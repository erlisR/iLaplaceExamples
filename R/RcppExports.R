...
seqMat <- function(par, se, lengthOut, q, delta) {
    .Call('iLaplaceExamples_seqMat', PACKAGE = 'iLaplaceExamples', par, se, lengthOut, q, delta)
}

ldetHessBlocks <- function(hessMat, dimMat) {
    .Call('iLaplaceExamples_ldetHessBlocks', PACKAGE = 'iLaplaceExamples', hessMat, dimMat)
}

SEv <- function(hessMat, dimMat) {
    .Call('iLaplaceExamples_SEv', PACKAGE = 'iLaplaceExamples', hessMat, dimMat)
}
...
ldetHess_nlogH <- function(randPar, fixPar, data) {
    .Call('iLaplaceExamples_ldetHess_nlogH', PACKAGE = 'iLaplaceExamples', randPar, fixPar, data)
}
